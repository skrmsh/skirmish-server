...
game_create_reqparse.add_argument("gamemode", type=str, help="Gamemode field is required!", required=True)

game_start_reqparser = reqparse.RequestParser()
game_start_reqparser.add_argument("delay", type=int, help="Delay field is required!", required=True)
